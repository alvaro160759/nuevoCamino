...
localDataBase.version(12).stores({
    AC_PARTEMAQUINARIA: "++cod,IDPARTEMAQ,IDCLIEPROV,PROVEEDOR,IDDOCUMENTO,IDCONSUMIDORMAQUINARIA,MAQUINA,"+
    "OPERARIO,IDOPERARIO,HORAS_TRAB,HORAS_TRAB1,TURNO,IDTURNOTRABAJO,TOTAL_COSTO,FORMAPAGO,TOTALAREA_TRAB"+
    "AREA,IDAREA,COSTO_HORA,IDUSUARIO,ESTADO,FECHA,HORAINICIO,HORAFINAL,HOROMETROINICIAL,HOROMETROFINAL,GLOSA,IDCONSUMIDORIMPLEMENTO,DESCIMPLEMENTO,DESCCONSUMIDOR,idmepresa,[FECHA+ESTADO+idempresa],[ESTADO+idempresa],[FECHA+IDCONSUMIDORMAQUINARIA+ESTADO+idempresa]",
    Combustibles:"++cod,id,descripcion,idmedida,idempresa",

});

//localDataBase.version(23).stores();
